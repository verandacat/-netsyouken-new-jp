...
<main>
    ...
    <section id="ranking-area" class="">
        ...
        <article class="rank-01" data-rank="5">
            <div class="r-title">
                ...
                <?php if($reslutArray[$c]['name'] == 'SBIネオトレード証券') : ?>

                <?php if(is_mobile()) : ?>
                <h3 class="livestar">
                    <a href="<?php echo $reslutArray[$c]['url'] ?>" target="_blank"
                        class="prrrr"><?php echo $reslutArray[$c]['name'] ?></a>
                    <small>（旧：ライブスター証券）</small>
                    <?php else : ?>
                    <h3 style="display:flex; flex-direction:column; ">
                        <a href="<?php echo $reslutArray[$c]['url'] ?>" target="_blank"
                            class="prrrr"><?php echo $reslutArray[$c]['name'] ?></a>
                        <small style="padding-left: 20px;">（旧：ライブスター証券）</small>
                        <?php endif; ?>
                    </h3>
                    <?php else : ?>
                    <h3 style="display:flex; flex-direction:column;">
                    ...
                    <?php if(is_mobile()) : ?>
                        <div class="all-eval-ctt">
                            <p>
                                <span><?php echo $reslutArray[$c]['sougou'] ?></span>点／100点
                            </p>
            ...
            <?php if(!empty($reslutArray[$c]['osusume_point1'])) : ?>
            ...
            <?php if (!empty($reslutArray[$c]['campaign'])) : ?>
            <div class="cam-box">
                <h4>期間限定キャンペーン情報！</h4>
    ...
    <section id="review-box">
        <article class="matsui-r" id="review">
            ...
            <?php endif; ?>
                <div>
                    <p><?php echo $reviewLoop[$v]['name']; ?>
                        <span class="small"><?php echo $reviewLoop[$v]['sub']; ?></span>
                        <?php if(!is_mobile()) : ?>
                        <img src="<?php echo $reviewLoop[$v]['star']; ?>" alt="" />
                        <?php endif; ?>
                    </p>
