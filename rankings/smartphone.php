...
function user_compare_data($a, $b){
        if ($a['rankSp'] == $b['rankSp']) {
            return 0;
        }
        return ($a['rankSp'] < $b['rankSp']) ? -1 : 1;
    }
...
<section id="ranking-area" class="">
    ...
    <div class="ranking-title">
        <?php if(is_mobile()) : ?>
        <h2>スマホでの取引におすすめの<br>証券会社ベスト<?php echo $count; ?>！</h2>
        <?php else : ?>
        <h2>スマホでの取引におすすめの証券会社ベスト<?php echo $count; ?>！</h2>
        <?php endif; ?>
    </div>
    <?php
    $i = 0;
    ...
    ?>
    <?php if($i <= 3) : ?>
    <article class="rank-0<?php echo $r['rankSp']; ?>" data-rank="<?php echo $r['rankSp']; ?>">
        <?php else : ?>
        <article class="rank-0<?php echo $r['rankSp']; ?>" data-rank="4">
            <?php endif; ?>
            <div class="r-title">
                <img class="badge" src="./img/badge-<?php echo $r['rankSp']; ?>-pc.png" alt="">
                ...
                <div class="right">
                    ...
                    <table class="rank-table">
                        <tbody>
                            ...
                            <tr>
                                <td>約定ごと</td>
                                <td><?php echo $r['pay_tesuryou_1_1'] ?></td>
                                <td><?php echo $r['pay_tesuryou_1_2'] ?></td>
                            </tr>
