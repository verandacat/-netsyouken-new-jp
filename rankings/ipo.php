...
function user_compare_data($a, $b){
    if ($a['rankIpo'] == $b['rankIpo']) {
        return 0;
    }
    return ($a['rankIpo'] < $b['rankIpo']) ? -1 : 1;
}
...
<section id="ranking-area" class="">
    ...
    <article class="rank-0<?php echo $r['rankIpo']; ?>" data-rank="<?php echo $r['rankIpo']; ?>">
        <?php else : ?>
        <article class="rank-0<?php echo $r['rankIpo']; ?>" data-rank="4">
            <?php endif; ?>
            <div class="r-title">
                <img class="badge" src="./img/badge-<?php echo $r['rankIpo']; ?>-pc.png" alt="">

                <h3>
                    <?php if(!empty($r['urlIpo'])) : ?>
                    <a href="<?php echo $r['urlIpo'] ?>" target="_blank" class="prrrr">
                        <?php else : ?>
                ...
                <div class="left img-title">
                    ...
                    <a href="<?php echo $r['urlIpo'] ?>" target="_blank" class="prrrr">
                        ...
                        <a href="<?php echo $r['url'] ?>" target="_blank" class="prrrr">
                            <?php endif; ?>
                            <p class="txt-img">
                                <?php if(!empty($r['imageIpo'])) : ?>
                                <img src="<?php echo $r['imageIpo'] ?>" alt="">
                                <?php else : ?>
            ...
            <div class="po-list">
                ...
                <ul>
                    <?php if(!empty($r['ipo_point1'])) : ?>
                    <li><?php echo $r['ipo_point1'] ?></span>
                    </li>
                    <li><?php echo $r['ipo_point2'] ?></li>

                    <?php if(!empty($r['ipo_point3'])) : ?>
                    <li><?php echo $r['ipo_point3'] ?></li>
                    <?php endif; ?>
            ...
            <div class="comment">
                ...
                <?php if(!empty($r['comment_ipo'])) : ?>
                <p><?php echo $r['comment_ipo'] ?></p>
                <?php else : ?>
