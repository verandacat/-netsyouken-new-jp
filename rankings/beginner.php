...
function user_compare_data($a, $b){
        ...
        if ($a['rankBeg'] == $b['rankBeg']) {
            return 0;
        }
        return ($a['rankBeg'] < $b['rankBeg']) ? -1 : 1;
...
<section id="ranking-area" class="">
    <div class="ranking-title">
        <?php if(is_mobile()) : ?>
        <h2>ネット証券人気ランキング<br>ベスト<?php echo $count; ?>を発表！</h2>
        <?php else : ?>
        <h2>ネット証券人気ランキングベスト<?php echo $count; ?>を発表！</h2>
        <?php endif; ?>
    </div>
    <h2></h2>
    <?php 
...
foreach ($reslutArray as $r ) {
    ...
    ?>
    <?php if($i <= 3) : ?>
    <article class="rank-0<?php echo $r['rankBeg']; ?>" data-rank="<?php echo $r['rankBeg']; ?>">
        <?php else : ?>
        <article class="rank-0<?php echo $r['rankBeg']; ?>" data-rank="4">
            <?php endif; ?>
            <div class="r-title">
