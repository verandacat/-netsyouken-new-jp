...
function user_compare_data($a, $b){
        ...
        if ($a['rankForeign'] == $b['rankForeign']) {
            return 0;
        }
        return ($a['rankForeign'] < $b['rankForeign']) ? -1 : 1;
    }
...
foreach ($reslutArray as $r) {
    ...
    <article class="rank-0<?php echo $r['rankForeign']; ?>" data-rank="<?php echo $r['rankForeign']; ?>">
        <?php else : ?>
        <article class="rank-0<?php echo $r['rankForeign']; ?>" data-rank="4">
            <?php endif; ?>
            <div class="r-title">
                <img class="badge" src="./img/badge-<?php echo $r['rankForeign']; ?>-pc.png" alt="">
