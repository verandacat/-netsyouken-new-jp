...
<section id="ranking-area" class="">
    ...
    if ($a['rankAll'] == null || $b['rankAll'] == null) {
    return ;
    }
    if ($a['rankAll'] == $b['rankAll']) {
    return 0;
    }
    return ($a['rankAll'] < $b['rankAll']) ? -1 : 1; } 
    ...
    <div class="ranking-title">
        ...
        <h2>ネット証券人気ランキング<br>ベスト<?php echo $count; ?>を発表！<br>
            <span class="titleSpan">
                <?php echo date('Y') ?>年<?php echo date('n') ?>月最新版</span>
        </h2>
        <?php else : ?>
        <h2>ネット証券人気ランキングベスト<?php echo $count; ?>を発表！<br>
            <span class="titleSpan">
                <?php echo date('Y') ?>年<?php echo date('n') ?>月最新版</span>
        </h2>
        <?php endif; ?>
