...
function user_compare_data($a, $b){
        ...
        if ($a['rankInvest'] == $b['rankInvest']) {
            return 0;
        }
        return ($a['rankInvest'] < $b['rankInvest']) ? -1 : 1;
    }
...
<section id="ranking-area" class="">
    <div class="ranking-title">
        <?php if(is_mobile()) : ?>
        <h2>投資信託におすすめの<br>証券会社ベスト<?php echo $count; ?>！</h2>
        <?php else : ?>
        <h2>投資信託におすすめの証券会社ベスト<?php echo $count; ?>！</h2>
        <?php endif; ?>
    </div>
    <?php
        $i = 0;
    ...
    <article class="rank-0<?php echo $r['rankInvest']; ?>" data-rank="<?php echo $r['rankInvest']; ?>">
        <?php else : ?>
        <article class="rank-0<?php echo $r['rankInvest']; ?>" data-rank="4">
            <?php endif; ?>
            <div class="r-title">
                <img class="badge" src="./img/badge-<?php echo $r['rankInvest']; ?>-pc.png" alt="">
            ...
            <div class="po-list">
                ...
                <ul>
                    <?php if(!empty($r['invest_point1'])) : ?>
                    <li><?php echo $r['invest_point1'] ?></span>
                    </li>
                    <li><?php echo $r['invest_point2'] ?></li>

                    <?php if(!empty($r['invest_point3'])) : ?>
                    <li><?php echo $r['invest_point3'] ?></li>
                    <?php endif; ?>
            ...
            <div class="comment">
                ...
                <?php if(!empty($r['comment_invest'])) : ?>
                <p><?php echo $r['comment_invest'] ?></p>
                <?php else : ?>
            ...
            <div class="kuchikomi-box">
                ...
                <h4><?php echo $r['name'] ?> 最新の口コミ<i class="fas fa-comments"></i></h4>
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide re-content <?php echo $reviewLoop[$v]['sex'] ?>">
                            <div>
                                <p><?php echo $reviewLoop[$v]['name'] ?><span
                                        class="small"><?php echo $reviewLoop[$v]['sub'] ?></span><img
                                        src="<?php echo $reviewLoop[$v]['star'] ?>" alt=""></p>
